...
def main():
    ...
    while i < 3:
        ...
        diceroll = (
            randint(1, 20))  # Might want to introduce more randomness so that the AI does more interesting things
...
class AI_recognizer:
    ...
    # For every set of images in the traning set
    # If image1.size() != image2.size() images dd not match
